...
def populate():
    ...
    achievements = [
        ...
        {'name': '1080p',
         ...
         'current_score_achievement': False},
        {'name': 'Hoarder',
         'description': 'Own 10000000 pixels. You know you can buy stuff right?',
         'condition': 10000000,
         'current_score_achievement': True},
        {'name': 'Millionaire',
         'description': 'Own 1mln pixels. You are a pixel millionaire now.',
         'condition': 1000000,
         'current_score_achievement': True},
        {'name': '4K Hollywood movie',
         'description': 'Get 8847360 pixels. You could make a 4K movie.',
         'condition': 8847360,
         'current_score_achievement': False},
        {'name': 'Alien wannabe',
         'description': 'Get 75000000000 pixels. You could have had an alien now.',
         'condition': 75000000000,
         'current_score_achievement': False},
        {'name': 'Have it all',
         'description': 'Get 129126382100 pixels. You could have one of each now ',
         'condition': 129126382100,
         'current_score_achievement': False},
    ]
